            ...
            @if($showActions)
                <div class="flex gap-1">
                    <flux:button 
                        ...
                        size="sm" 
                        icon="heart" 
                        class="{{ $isLiked ? 'opacity-100 text-red-500 hover:text-red-600 dark:hover:text-red-400' : 'opacity-0 group-hover:opacity-100 hover:text-red-500 dark:hover:text-red-400' }} transition-opacity"
                    ...
                    <flux:button 
                        ...
                        size="sm" 
                        icon="bookmark" 
                        class="{{ $isBookmarked ? 'opacity-100 text-blue-500 hover:text-blue-600 dark:hover:text-blue-400' : 'opacity-0 group-hover:opacity-100 hover:text-blue-500 dark:hover:text-blue-400' }} transition-opacity"
